...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { delegacion_id: @equipo.delegacion_id, disciplina_id: @equipo.disciplina_id }
    end
  ...
  test "should update equipo" do
    put :update, id: @equipo, equipo: { delegacion_id: @equipo.delegacion_id, disciplina_id: @equipo.disciplina_id }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
