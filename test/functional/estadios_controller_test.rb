...
class EstadiosControllerTest < ActionController::TestCase
  ...
  test "should create estadio" do
    assert_difference('Estadio.count') do
      post :create, estadio: { cordx: @estadio.cordx, cordy: @estadio.cordy, direccion: @estadio.direccion, nombre: @estadio.nombre, olipiada_id: @estadio.olipiada_id }
    end
  ...
  test "should update estadio" do
    put :update, id: @estadio, estadio: { cordx: @estadio.cordx, cordy: @estadio.cordy, direccion: @estadio.direccion, nombre: @estadio.nombre, olipiada_id: @estadio.olipiada_id }
    assert_redirected_to estadio_path(assigns(:estadio))
  end
